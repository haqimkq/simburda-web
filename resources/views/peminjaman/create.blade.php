        ...
        @if (!$barangs->isEmpty())
            @if (request('search'))
                <div class="flex items-center mb-5">
                    <button
                        class="bg-red-600 py-1 px-2 mr-2 text-center font-normal text-sm delete_search text-white rounded-md"
