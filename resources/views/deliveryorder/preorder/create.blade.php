...
@section('content')
		...
		<h1 class="my-6 w-full text-center text-lg font-bold uppercase">Tambah Pre Order</h1>
		<div class="mb-6 grid w-[80vw] gap-6 grid-cols-2 md:grid-cols-4">
			<p class="mb-2 font-medium text-sm"><span class="text-xs text-gray-500">Tanggal Pengambilan</span> <br>{{ App\Helpers\Date::parseMilliseconds($deliveryOrder->tgl_pengambilan) }}</p>
			<p class="mb-2 font-medium text-sm"><span class="text-xs text-gray-500">Kode Delivery Order</span> <br>{{ $deliveryOrder->kode_do }}</p>
			<p class="mb-2 font-medium text-sm"><span class="text-xs text-gray-500">Untuk Perhatian</span> <br>{{ $deliveryOrder->untuk_perhatian }}</p>
			<p class="mb-2 font-medium text-sm"><span class="text-xs text-gray-500">Perihal</span> <br>{{ $deliveryOrder->perihal }}</p>
				...
				<div id="perusahaan-preview"
						...
						<div class="flex flex-col">
								...
								<p class="mb-2 font-medium line-clamp-1 md:line-clamp-2 xl:line-clamp-3">{{ $deliveryOrder->perusahaan->nama }}
								</p>
								<p class="mb-2 text-sm font-normal text-gray-700 line-clamp-1 md:line-clamp-2 xl:line-clamp-3">
		...
		<form method="POST" action="{{ route('delivery-order.storeCreateStepTwo') }}">
				@csrf
					...
					<div class="pre-order-item mb-6 grid w-[80vw] gap-6 md:grid-cols-6 rounded-xl p-3 shadow-md shadow-gray-100">
							<div class="flex w-full flex-col">
									<label for="nama_material" class="mb-2 block text-[0.7em] font-medium text-gray-900 dark:text-gray-300">Nama
											material</label>
									<input type="text" name="preorder[0][nama_material]" placeholder="Nama material"
							...
							<div class="flex w-full flex-col">
									...
									<input type="text" name="preorder[0][ukuran]" placeholder="Ukuran"
											class="dark: block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-[0.7em] text-gray-900 focus:ring-green dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:ring-green"
											required />
									@error('ukuran')
											@include('shared.errorText')
							...
							<div class="flex w-full flex-col">
									...
									<input type="number" min="1" name="preorder[0][jumlah]" placeholder="Jumlah"
											class="dark: block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-[0.7em] text-gray-900 focus:ring-green dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:ring-green"
											required />
									@error('jumlah')
											@include('shared.errorText')
							...
							<div class="flex w-full flex-col">
									...
									<input type="text" name="preorder[0][satuan]" placeholder="Satuan"
											class="dark: block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-[0.7em] text-gray-900 focus:ring-green dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:ring-green"
											required />
									@error('satuan')
											@include('shared.errorText')
							...
							<div class="flex w-full flex-col">
									...
									<input type="text" name="preorder[0][keterangan]" placeholder="Keterangan"
											class="dark: block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-[0.7em] text-gray-900 focus:ring-green dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:ring-green" />
									@error('keterangan')
											@include('shared.errorText')
									@enderror
							...
							<div class="flex self-end">
									<button type="button" id="btn-add-item"
											class="w-auto self-end rounded-lg border-2 border-blue-600 px-4 py-2 text-center text-lg font-medium text-blue-600 hover:border-blue-500 hover:text-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-300 sm:w-auto">
											+
									</button>
							</div>
					</div>
				...
				<div class="flex justify-center">
						<a id="btn-back" href="{{ route('delivery-order.createStepOne') }}"
