...
@section('content')
				...
				<ol class="inline-flex items-center space-x-1 md:space-x-3">
						<li class="inline-flex items-center">
								<a href="{{ route('home') }}"
										...
										Home {{ $deliveryOrder->logistic_id }}
								</a>
						</li>
						<li>
		...
		<div class="flex items-center justify-end">
				<div class="my-2 flex w-full flex-col">
						...
						<p class="mt-1 self-start rounded-full border border-green px-3 py-1 text-sm text-green">
				...
				<a href="{{ route('signature.verifiedTTDDeliveryOrder', $deliveryOrder->ttd) }}" target="_blank"
						class="mr-5 rounded-md bg-green-400 px-3 py-1 text-white">
						Verifikasi TTD
				</a>
				<a href="{{ route('delivery-order.downloadPDF', $deliveryOrder->id) }}" target="_blank"
						class="rounded-md bg-primary px-3 py-1 text-white">
						Download PDF
				</a>
		</div>
		<div class="my-3 grid gap-2 md:grid-cols-2">
				<div class="page row-span-2 flex w-full flex-col overflow-scroll p-5 text-sm">
								...
								<div class="flex flex-col">
										...
										<div class="flex">
												@if ($ttdPath)
														...
														<div class="bg-contain bg-center bg-no-repeat">
																<img src="{{ asset("assets/ttd-verification/$deliveryOrder->ttd.png") }}" alt=""
