	...
	<div class="w-full pl-4">
		...
		@if (!$deliveryOrders->isEmpty())
				...
				<div class="flex items-center">
					...
					<h1 class="mb-2 text-center font-medium text-md">Hasil Pencarian Delivery Order {{request('search')}}</h1>
				</div>
				@endif
		...
		@else
			@if (request('search'))
				<h1 class="mb-2 text-center font-medium text-md text-red-600">Tidak ada Delivery Order {{request('search')}}</h1>
			@else
				<h1 class="mb-2 text-center font-medium text-md text-red-600">Belum ada Delivery Order</h1>
			@endif
		@endif
	<div class="mt-5">
