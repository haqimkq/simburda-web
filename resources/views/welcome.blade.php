...
<html lang="en">
  ...
  <body class="lg:block flex flex-col-reverse  md:flex-row items-center justify-center">
    ...
    <div class="flex lg:flex-row flex-col-reverse md:flex-col-reverse">
      <div class="grid grid-flow-row grid-cols-3">
        <img class="lg:block col-span-3 w-[10vw] lg:w-[50vw] h-auto self-start sm:hidden hidden" src="{{asset('images/hero-top-left.png')}}" alt="">
        <img class="lg:block col-span-2 w-[10vw] lg:w-[50vw] h-auto self-start lg:self-end sm:hidden hidden" src="{{asset('images/hero-bottom-left.png')}}" alt="">
      </div>
      <div class="h-[40vh] w-[15em] md:w-[50vw] md:h-screen xl:w-full xl:h-screen bg-cover bg-right md:bg-left" style="background-image: url({{asset('images/hero-right.png')}})">
