<form id="form" class="grid md:grid-cols-2 xl:grid-cols-4 gap-2 items-end w-full mb-2" action="@yield('action')">
    ...
    <div class="inline-flex">
        ...
        <div class="relative w-full">
            ...
            <input name="search" type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green focus:border-greenring-green block w-full pl-10 p-2.5" placeholder="@yield('placeholderSearch')" value="{{request('search')}}" autofocus>
        </div>
