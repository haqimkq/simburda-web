...
<html lang="en">
    ...
    <body>
        <div class="flex items-center justify-center min-h-screen bg-primary  bg-fixed bg-cover bg-bottom error-bg"
                ...
                <div class="row">
                    <div class="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
                        ...
                        <h1 class="relative text-9xl tracking-tighter-less text-shadow font-sans font-bold">
                            <span>@yield('code1')</span><span>@yield('code2')</span><span>@yield('code3')</span></h1>
                        ...
                        <p class="text-gray-100 mt-2 mb-6">@yield('message')</p>
                        <a  href="/"
                            class="bg-green  px-5 py-3 text-sm shadow-sm font-medium tracking-wider text-gray-50 rounded-full hover:shadow-lg">
                            Go to Home
                        </a>
                    </div>
                </div>
