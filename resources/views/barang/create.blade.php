...
<h1 class="text-lg font-bold uppercase my-6 w-full text-center">Tambah Barang</h1>
  ...
  Cara Mengambil Longitude</a>
			...
			<div>
				...
				<img class="mb-2" id="preview-image" src="https://img.freepik.com/free-vector/illustration-gallery-icon_53876-27002.jpg?w=740&t=st=1662267352~exp=1662267952~hmac=f0385ce0a49bd1243809578d71f8efef2a35d44a28cb49ff48186f6c1e7834a8"
						alt="preview image" style="max-height: 200px;">
				<input
					class="self-start block w-full cursor-pointer rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:placeholder-gray-400"
