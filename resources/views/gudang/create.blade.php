...
<h1 class="text-lg font-bold uppercase my-6 w-full text-center">Tambah Gudang</h1>
	<form method="POST" action="{{ route('gudang.store') }}" enctype="multipart/form-data">
		...
		<div class="mb-6 grid gap-6 md:grid-cols-2 w-[80vw]">
			...
			<div class="@can('admin') block md:col-span-2 @elsecan('project-manager')  @endcan">
				<label for="alamat" class="mb-2 block text-sm font-medium text-gray-900 dark:text-gray-300">Alamat Gudang</label>
