...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'set-manager' => \App\Http\Middleware\isSetManager::class,
        ...
        'admin-setmanager' => \App\Http\Middleware\isAdminOrSetManager::class,
        'admin-setmanager-supervisor' => \App\Http\Middleware\isAdminOrSetManagerOrSupervisor::class,
        'admin-setmanager-supervisor-admingudang' => \App\Http\Middleware\isAdminOrSetManagerOrSupervisorOrAdminGudang::class,
