...
class SjPengirimanGpFactory extends Factory
{
    ...
    public function configure(){
        return $this->afterCreating(function (SjPengirimanGp $sjPengirimanGp) {
            $penggunaanGp = $sjPengirimanGp->penggunaanGp;
            $penggunaan = $sjPengirimanGp->penggunaanGp->penggunaan;
            ...
            //     $admin_gudang_id = $penggunaanPp->penggunaanAsal->gudang->adminGudang->random(1)->all()[0]->user_id;
