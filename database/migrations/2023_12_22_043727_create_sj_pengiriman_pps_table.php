...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('sj_pengiriman_pps', function (Blueprint $table) {
            ...
            $table->foreignUuid('peminjaman_id')->nullable()->constrained('peminjaman_pps')->onUpdate('cascade')->onDelete('cascade');
            $table->foreignUuid('penggunaan_id')->nullable()->constrained('penggunaan_pps')->onUpdate('cascade')->onDelete('cascade');
